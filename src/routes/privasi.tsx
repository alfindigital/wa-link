  ...
  head: () => ({
    meta: [
      { title: "Privasi & Disclaimer — WAlinkQ" },
      {
        name: "description",
        content:
          "WAlinkQ menyimpan nomor, pesan, dan riwayat hanya di perangkat kamu. Tanpa akun, tanpa tracking, input generator tidak dikirim ke cloud.",
      },
  ...
  const sections = [
    {
      ...
      body: "Nomor, pesan, riwayat, template, dan pengaturan disimpan di browser HP kamu (localStorage). WAlinkQ tidak punya database dan tidak mengirim input kamu ke server manapun.",
    },
    {
      icon: EyeOff,
    ...
    },
    {
      ...
      body: "Gunakan tombol Hapus / Hapus semua di menu Riwayat, atau bersihkan data situs untuk domain ini dari pengaturan browser.",
    },
    {
      icon: Info,
      title: "Disclaimer",
      body: "WAlinkQ bukan produk resmi dan tidak berafiliasi dengan WhatsApp Inc. atau Meta. WhatsApp adalah merek dagang milik Meta Platforms, Inc.",
    },
  ];
      ...
      <main className="mx-auto w-full max-w-xl flex-1 px-4 pt-8 pb-4 sm:px-6 sm:pt-12 sm:pb-6">
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground sm:text-sm">Ringkas, jujur, data lokal.</p>
          </div>
        </div>
